    ...
    settingsDialog: class {
      ...
      getAboutTabHTML() {
        ...
        <div class="liems-about-center">
          <div class="liems-about-icon">${SettingsModule.icons.luculent}</div>
